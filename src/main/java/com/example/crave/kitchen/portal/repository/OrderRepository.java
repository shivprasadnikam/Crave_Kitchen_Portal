...
public interface OrderRepository extends JpaRepository<OrderEntity, Long> {
    ...
    List<OrderEntity> findByCustomerIdAndCreatedAtBetweenOrderByCreatedAtDesc(Long customerId, LocalDateTime startDate,
    ...
    List<OrderEntity> findByCustomerIdAndTotalAmountBetweenOrderByCreatedAtDesc(Long customerId, BigDecimal minAmount,
